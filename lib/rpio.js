...
function detect_pinmap()
{
	...
	if(m = model.match(/Radxa Zero/)) {
		console.log("--Found Radxa Zero SBC");
		soctype = rpio.prototype.SOC_S905Y2;
		pinmap = 'PINMAP_RZ_S905Y2';
		return true;
	}
